...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> NITRATE_ORE = registerBlock("nitrate_ore",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).strength(3.0f).requiresCorrectToolForDrops()));
